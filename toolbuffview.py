...
𝑩𝒚 𝑻𝒓𝒊𝒄𝒌𝒆𝒓 𝑯𝒐 𝑫𝒖𝒄 𝑴𝒊𝒏𝒉
𝑻𝒐𝒐𝒍 𝒅𝒄 𝒍𝒂𝒑 𝒕𝒓𝒊𝒏𝒉 𝒃𝒂𝒏𝒈 𝒑𝒚𝒕𝒉𝒐𝒏 𝒏𝒆𝒏 𝒍𝒖𝒖 𝒚 𝒌𝒉𝒊 𝒔𝒖 𝒅𝒖𝒏𝒈 
𝑇ℎ𝑎𝑐 𝑚𝑎𝑐 𝑙𝑖𝑒𝑛 ℎ𝑒 0773.150.128
𝐇𝐨𝐚𝐜 𝐀𝐝𝐝: https://www.facebook.com/yeuemthemmotchut
                                                                     

\033[1;37m────────────────────────────────────────────────────────────
{do}[{trang}{kt_code}{do}] {vang}View tik tok by Ho Duc Minh 
{do}[{trang}{kt_code}{do}] \033[1;35mADMIN:\033[1;36mHODUCMINH
{do}[{trang}{kt_code}{do}] \033[1;31mZALO: \033[1;33mhttps://zalo.me/0773150128
{do}[{trang}{kt_code}{do}] \033[1;32mBOX SUPPORT: \033[1;37mhttps://zalo.me/g/0773150128
{do}[{trang}{kt_code}{do}] {dac_biet}YOUTUBE:\033[1;37mHODUCMINH
\033[1;37m────────────────────────────────────────────────────────────"""
        ...
        try:
            ...
            try:
                if response.json()['status_code'] == 0:
                    _lock.acquire()
                    print(f'{do}[{vang}HO DUC MINNH{do}] {do}[{xanh_la}BUFF VIEW THANH CONG{do}] {do}{xanh_duong}+: {trang}{success}{do} View')
                    success += 1
                    _lock.release()
            except:
